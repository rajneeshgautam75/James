...
public class ExportPage_POM 
{
	...
	@FindBy(xpath=".//*[@id='ze-main-app']/zee-test-repository/test-repository-component/div[2]/div[2]/div[1]/section/div/zui-zephyr-search/div/div[2]/div/button")
	...
	public WebElement dateFieldOption;
	 ...
	 @FindBy(xpath="(//a[@class='btn inline-calendar-trigger'])[1]")  //added/////////////////////////////////////////////////
	 protected WebElement startDateOption;
	 
	 @FindBy(xpath="(//a[@class='btn inline-calendar-trigger'])[2]")  //added/////////////////////////////////////////////////
