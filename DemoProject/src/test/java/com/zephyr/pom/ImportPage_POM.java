...
//	public WebElement selectMap;
	...
	@FindBy(xpath="//*[@id='importJobs-fields']/div[2]/span[2]/select")
	public WebElement mapSelection;
	
	@FindBy(xpath="//*[@id='fromLocal']/div/attachments/div/div/p/span")
...
//	public WebElement selectImportJob;
	...
	@FindBy(xpath="//*[@class='grid-action-icon fa fa-play-circle-o runJobs']")              
	...
	@FindBy(xpath="//div/zee-custom-fields//strong[contains(@title, 'CustomCheckbox')]/following-sibling::span")
