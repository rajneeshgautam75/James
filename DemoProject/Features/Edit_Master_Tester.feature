...
#BP cxheck
@Edit
Scenario: 58 803030_Copy multiple test cases from Global import node to current the phase
Given User in Repository page
...
#BP
@Edit
Scenario: 59 803046_Copy an imported node to a local P/S/SS and delete the import node
Given User in The Repository page
...
#BP f 
@Edit
Scenario: 60 797103_Edit teststeps and view the step history
